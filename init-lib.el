...
(defun my/counsel-recentf-misc ()
  (interactive)
  (let ((filter "\\.c$\\|\\.h$\\|\\.cpp$\\|\\.hpp$\\|\\.el$\\|\\.el.gz$\\|\\.java$\\|\\.json$\\|\\.log$\\|\\.org$\\|\\.py$\\|\\.sh$\\|\\.xml$\\|Dockerfile\\|\\.[cs]ql$")
...
(defun my/counsel-recentf-java (&optional projectile)
  (interactive "P")
  (my/counsel-recentf-filtered "\\.java$" projectile))
