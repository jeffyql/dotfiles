...
(defhydra hydra-recentf (:color blue)
  ("c" my/consult-recentf-c "c++")
  ("e" my/consult-recentf-el "el")
  ("j" projectile-recentf)
  ("l" my/consult-recentf-log "log")
  ("m" my/consult-recentf-misc "misc")
  ("n" my/consult-recentf-json "json")
  ("p" my/consult-recentf-py "python")
  ("q" my/consult-recentf-sql-cql "[sc]ql")
  ("s" my/consult-recentf-sh "sh")
  ("t" my/consult-recentf-txt "txt")
  ("v" my/consult-recentf-java "java")
  ("x" my/consult-recentf-xml "xml")
  ("r" consult-recentf "recent")
  ("," my/consult-recentf-set-file-extension "set designated")
  ("." my/consult-recentf-designated "designated")
  )
...
(defhydra hydra-toggle (:color blue)
  ...
  ("c"   toggle-code-cells-mode "tabbar")
